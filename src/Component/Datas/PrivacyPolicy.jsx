      ...
      <div className="space-y-12 text-base leading-relaxed text-gray-600 font-light">
        <section>
          <p>
            ...
            purchase from <strong className="text-black font-medium">karikku.co</strong> (the "Site") or otherwise communicate with us (collectively, 
        ...
        <section>
          <h2 className="text-xl md:text-2xl font-normal text-black mb-4">Changes to This Privacy Policy</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl md:text-2xl font-normal text-black mb-4">How We Collect and Use Your Personal Information</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl md:text-2xl font-normal text-black mb-6">What Personal Information We Collect</h2>
          
          <div className="mb-8">
            <h3 className="text-lg font-medium text-black mb-2">Information We Collect Directly from You</h3>
            <p className="mb-3">This includes:</p>
            <ul className="list-disc list-outside space-y-2 ml-5 text-gray-600">
          ...
          <div className="mb-8">
            <h3 className="text-lg font-medium text-black mb-2">Information We Collect through Cookies</h3>
            <p>
          ...
          <div>
            <h3 className="text-lg font-medium text-black mb-2">Information We Obtain from Third Parties</h3>
        ...
        <section>
          <h2 className="text-xl md:text-2xl font-normal text-black mb-4">How We Use Your Personal Information</h2>
        ...
        <section>
          <h2 className="text-xl md:text-2xl font-normal text-black mb-4">Cookies</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl md:text-2xl font-normal text-black mb-4">How We Disclose Personal Information</h2>
        ...
        <section>
          <h2 className="text-xl md:text-2xl font-normal text-black mb-4">User Generated Content</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl md:text-2xl font-normal text-black mb-4">Third Party Websites and Links</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl md:text-2xl font-normal text-black mb-4">Children's Data</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl md:text-2xl font-normal text-black mb-4">Security and Retention of Your Information</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl md:text-2xl font-normal text-black mb-4">Your Rights and Choices</h2>
          <p className="mb-3">You may have rights depending on your location, including:</p>
          <ul className="list-disc list-outside space-y-2 ml-5 text-gray-600">
          ...
          <p className="mt-4">You may exercise your rights by contacting us directly.</p>
        </section>

        <section>
          <h2 className="text-xl md:text-2xl font-normal text-black mb-4">Complaints</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl md:text-2xl font-normal text-black mb-4">International Users</h2>
          <p>
        ...
        <section className="pt-8">
          <h2 className="text-xl md:text-2xl font-normal text-black mb-6">Contact Us</h2>
          <p className="mb-6">If you have questions or wish to exercise your data rights, contact:</p>
          <div className="space-y-3">
            <div>
              <strong className="text-black font-medium">Address:</strong> Karikku ventures private limited, Perinthalmanna, Kerala, India, 679322
            </div>
            <div>
              <strong className="text-black font-medium">Email:</strong> <a href="mailto:care@karikku.co" className="text-gray-900 hover:text-black hover:underline transition-colors">care@karikku.co</a>
            </div>
            <div>
              <strong className="text-black font-medium">Phone:</strong> (+91) 8589 8585 22/44/88
            </div>
          </div>
        </section>
      </div>
